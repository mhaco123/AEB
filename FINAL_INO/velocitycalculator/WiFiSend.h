/* this cod send parameters NAME,VALUE and UNIT via UDP protocol and WiFi Adafruit_CC3000 Module to Ground Control Station (GSC)
 ...
 * add this phrase to beginning after your cod "#include" :#include "WiFiSend.h"
...
//    int Parameter2=2;
     if (udpclient.connected()) {
     udpclient.print(
     "pulse_counter:\t"+String(pcounter)+"\t()\n"
     +"delta_t:\t"+String(delta_t)+"\t(s)\n"
     +"filtered rpm:\t"+String(rpm)+"\t(rev/min)\n"
     );
  }
}
