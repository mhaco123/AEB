...
void velocity_sensing_SetupFunction () {
  ...
  pinMode(interruptPin2, INPUT_PULLUP);// input port with mode pull-up
  attachInterrupt(interruptPin2,VS_interrupt_act, CHANGE );
}
...
void velocity_sensing_LoopFunction () {
  ...
  if (delta_t>50)
  {
    ...
    t1=t2;
        ...
        Serial.print("  Veloctiy: ");
        Serial.println(WF*0.05);  //print the rpm
